...
# import os
# import sys
# path_abs = os.path.dirname(os.path.abspath(__file__))##当前文件路径
# path = os.path.join(path_abs, "D:/Python-text/Neural Networks and Deep Learning/nlp_induction_training/task1/config")
